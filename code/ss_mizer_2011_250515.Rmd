...
ss_species_params <-   read.csv(
  "/Users/vivtulloch/Dropbox/UBC/Projects/Orca_salmon_modelling/07_sizespectra/Viv_sizespectra_model/Salish_Sea/pars2025/ss_mizer_2011_pars_250813.csv")

ss_gear_params<-read.csv("/Users/vivtulloch/Dropbox/UBC/Projects/Orca_salmon_modelling/07_sizespectra/Viv_sizespectra_model/Salish_Sea/pars2025/gear_params2011_allfisheries_250813.csv")

ss_interaction <-   read.csv(
    "/Users/vivtulloch/Dropbox/UBC/Projects/Orca_salmon_modelling/07_sizespectra/Viv_sizespectra_model/Salish_Sea/pars2025/interaction_params121216_upd_addotherfish.csv", row.names=1)
...
```{r}
saveParams(tuned_model, "ss_mizerout2011_pars_fishing1.rds")
dfnew<-(species_params(tuned_model))

write.csv(dfnew, "/Users/vivtulloch/Dropbox/UBC/Projects/Orca_salmon_modelling/07_sizespectra/Viv_sizespectra_model/Salish_Sea/ss_pars_May25/pars_241212/ss_mizerout2011_pars_fishing1.csv")
saveParams(tuned_model, "/Users/vivtulloch/Dropbox/UBC/Projects/Orca_salmon_modelling/07_sizespectra/Viv_sizespectra_model/Salish_Sea/ss_pars_May25/pars_241212/ss_mizerout2011_pars_fishing1.rds")
```
...
We do not know how much we need to reduce the reproduction level to get a sufficiently low F MSY. We just try some values. Let’s try 0.3.
